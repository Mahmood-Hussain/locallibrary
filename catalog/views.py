...
class LoanedBooksByUserListViewForLibrarian(LoginRequiredMixin, PermissionRequiredMixin, generic.ListView):
    permission_required = 'catalog.can_mark_returned'
    """
    Generic class-based view listing books on loan to current user visible to librarian only
    """
    model = BookInstance
    template_name = 'catalog/student_books_list_borrowed.html'
    paginate_by = 10
